...
const ENCODING_FIXES = {
  ...
  'ко��орая': 'которая',
  'ничего н�� получится': 'ничего не получится',
  'т��к же': 'так же',
  'лежит��': 'лежите',
  'инс��йты': 'инсайты',
  '��кептически': 'скептически',
  'бе��': 'без',
  'расширени��': 'расширение',
  'психик��й': 'психикой',
  '��нергии': 'энергии',
  'поддерж��вающе��': 'поддерживающей',
  'вый��и': 'выйти',
  'Акти��ация': 'Активация',
  'каждо��о': 'каждого',
  'у��астников': 'участников',
  '��ессия': 'сессия',
  'офла��н': 'офлайн',
  'Индив��дуальная': 'Индивидуальная',
  'рас��рылось': 'раскрылось',
  'сба��ансированную': 'сбалансированную',
  'рабо��у': 'работу',
  'целос��ность': 'целостность',
  'акт��вации': 'активации',
  'гл��зами': 'глазами',
  'како��-то': 'какой-то',
  'пер��ой': 'первой',
  ...
  '��сности': 'ясности',
  'К��нтакты': 'Контакты',
  'Запис��ться': 'Записаться',
  'Он��айн': 'Онлайн',
  'он��айн': 'онлайн',
  '��еню': 'меню',
  'Обы��но': 'Обычно',
  'внутрен��ие': 'внутренние',
  'тел��м': 'телом',
  'состояни��': 'состояние',
  'к��ждого': 'каждого',
  'у��астников': 'уча��тников',
};
